...
import styles from "../Pages/Styles/WomenHomePage.module.css";
...
{/* //6 */}
      ...
      <Stack borderBottom={"1px solid #ecedeb"} pt={"45px"}  m={'auto'} w={'82%'} >
      <Box>
          <Heading
            textAlign={"left"}
            fontWeight={"normal"}
      ...
      <Box p={'32px 0 40px 0'}>
            <Button cursor={'pointer'} _hover={{border:"1px solid #faa619"}} bg={'transparent'} fontSize={'14px'} color={'#faa619'} borderRadius={'2px'} p={'13px 10px 11px 10px'} w={296} border={'1px solid #D6D8F0'} >
              SEE ALL
            </Button>
      </Box>
